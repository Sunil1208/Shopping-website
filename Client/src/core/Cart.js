...
//         return(
//             <div>
//                 <h2>This section is to load checout</h2>
//             </div>
//         )
//     }
  ...
  return (
    ...
    {products.length > 0 ? (
      ...
      <div className="row text-center">
        ...
        {products.length > 0 ? (
            <div>
            <div className="bg-dark rounded-pill px-4 py-3 text-uppercase font-weight-bold">Order summary </div>
            <div className="p-4">
              ...
              </ul><StripeCheckout className="btn btn-dark rounded-pill py-2 btn-block" amount={getFinalPrice()} count={getCount()}  products={products} setReload={setReload} />
